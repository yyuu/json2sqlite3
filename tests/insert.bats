...
@test "insert JSON records into existing table generated by DuckDB" {
  # DuckDB generates columns as VARCHAR for all non-numeric values.
  # To enhance interoperability, json2sqlite3 needs to convert JSON array
  # and objects into string representation of their values.
  database_file="$(generate_database_file "${BATS_TEST_FILENAME##*/}")"
  table_name="$(generate_table_name "${BATS_TEST_FILENAME##*/}")"
  sqlite3 -init "/dev/null" "${database_file}" <<SQL
